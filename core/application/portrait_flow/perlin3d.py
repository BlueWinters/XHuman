# reference: https://github.com/pvigier/perlin-numpy/blob/master/perlin_numpy/perlin3d.py
import numpy as np
from .perlin2d import interpolate
...
def generate_perlin_noise_3d(
    ...
    Args:
        ...
        interpolate: The interpolation function, defaults to
            t*t*t*(t*(t*6 - 15) + 10).
...
def generate_fractal_noise_3d(
        ...
        tileable=(False, False, False), interpolate=interpolate
):
